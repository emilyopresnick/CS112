...
public class Sort {
    ...
    public static void selectionSort(int[] arr) {
        ...
        for (int i = 0; i < arr.length - 1; i++) {
            ...
            swap(arr, i, j);
            count++;
            System.out.println(count +" selection: "+ Arrays.toString(arr));
        }
    }
    ...
    public static void insertionSort(int[] arr) {
        ...
        for (int i = 1; i < arr.length; i++) {
            count++;
            if(i==5){
                System.out.println("instertion 5" + Arrays.toString(arr));
            }
            if (arr[i] < arr[i-1]) {
    ...
    public static void bubbleSort(int[] arr) {
        ...
        for (int i = arr.length - 1; i > 0; i--) {
            ...
            count++;
            System.out.println(count +" bubble: "+ Arrays.toString(arr));
        }
    }
    
    public static int callPart=0;
      ...
      int leftStart, int leftEnd, int rightStart, int rightEnd)
    {
        count++;
        if(count==4){
            System.out.println("4 th merge call " +Arrays.toString(arr));
        }
    ...
    public static void main(String[] arr) { 
        int[]arr1= {24,3,27,13,34,2,50,12};
        selectionSort(arr1);
        int[]arr2= {24,3,27,13,34,2,50,12};
        insertionSort(arr2);
        int[]arr3= {24,3,27,13,34,2,50,12};
        bubbleSort(arr3);
        int[]arr4= {24,3,27,13,34,2,50,12};
        quickSort(arr4);
        int[]arr5= {24,3,27,13,34,2,50,12};
        mergeSort(arr5);
        /*
