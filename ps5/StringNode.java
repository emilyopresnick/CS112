...
public class StringNode {
    ...
    public static int compareAlpha(StringNode str1, StringNode str2) {
        ...
        StringNode other=str2;
        while( trav!=null && other!=null){
            if(trav.ch>other.ch){
                return 2;
            }
            else if(other.ch>trav.ch){
                return 1;
            }
            trav=trav.next;
            other=other.next;
    ...
    public static StringNode copy(StringNode str) {
        ...
        StringNode copyN=head;
        while(trav!=null){
            StringNode temp=new StringNode(trav.ch,null);
            copyN.next=temp;
            trav=trav.next;
            copyN=copyN.next;
        }
    ...
    public static void doubleChar(char c, StringNode str) {
        ...
        while(trav!=null){
            ...
            if(trav.ch==c){
                StringNode newC=new StringNode(c,null);
                newC.next=trav.next;
                trav.next=newC;
                trav=newC.next;
     ...
     * before the first occurrence of the specified character (beforeChar)
     * in the linked-list string to which str refers.
    ...
    public static void main(String[] args) throws IOException {
        ...
        StringNode str = convert("banana");
        insertBefore(str, 'c', 'n');

        System.out.println("instert c before n of banana: " + str);
