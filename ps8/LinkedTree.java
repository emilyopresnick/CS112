...
public class LinkedTree {
    ...
    public void insert(int key, Object data) {
        ...
        //if(newNode.parent!=null) System.out.println(newNode.key + " parent: " + newNode.parent.key);
    }
    ...
    private class InorderIterator implements LinkedTreeIterator {
        ...
        //constructor for inorderiterator iterator
        ...
        //next method for in order iterator returns the key of the next value
        public int next() {
            if (nextNode==null) {
                throw new NoSuchElementException();
            }
            ...
            //stores parent of node
            Node p = nextNode.parent;

            
            if (nextNode.right!=null) {

                if (nextNode.right.left==null){
                    nextNode=nextNode.right;
                }
    ...
    public static void main(String[] args) {
        System.out.println("(0) Testing preorder : ");
        try {
            LinkedTree tree=new LinkedTree();
            int[] k = {44,35,23,28,53,48,62,57,80};
            tree.insertKeys(k);
            ...
            String expected="44 35 23 28 53 48 62 57 80 ";
        ...
        System.out.println("(1) Testing inorder : ");
        try {
            LinkedTree tree=new LinkedTree();
            int[] k = {44,35,23,28,53,48,62,57,80};
            tree.insertKeys(k);
            ...
            System.out.println(result);
            System.out.println("expected results:");
            String expected="23 28 35 44 48 53 57 62 80 ";
            System.out.println(expected);
            System.out.print("MATCHES EXPECTED RESULTS?: ");
            System.out.println(result.equals(expected));
        }
        ...
        System.out.println("(2) Testing inorder : ");
        try {
            LinkedTree tree=new LinkedTree();
            int[] k = {10,12,5,3,4,11,2,6,7,8};
            tree.insertKeys(k);
            LinkedTreeIterator iter = tree.inorderIterator();
            String result="";
            while (iter.hasNext()) {
            ...
            System.out.println(result);
            System.out.println("expected results:");
            String expected="3 12 6 4 7 10 11 5 2 8 ";
            System.out.println(expected);
            System.out.print("MATCHES EXPECTED RESULTS?: ");
            System.out.println(result.equals(expected));
        }
